        ...
        <nav class="navigation">
            <ul class="section_nav">
                <?php if (!isset($_SESSION['usuario'])): ?>
                    <li><a href="vista/Registrarse.php">Registrarse</a></li>
                    <li><a href="vista/IniciarSesion.php">Iniciar sesión</a></li>
                    <li><a href="vista/IniciarSesionadmin.php">Iniciar sesión como administrador</a></li>
                <?php else: ?>
            ...
            <ul>
                <li><a href="vista/catalogo.php">Catálogo</a></li>
...
function confirmarCerrarSesion() {
    ...
    if (confirmacion) {
        ...
        window.location.href = 'vista/CerrarSesion.php';
    }
}
</script>